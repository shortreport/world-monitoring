...
・【固有名詞】人名・国名・地名は日本語の正式表記（漢字またはカタカナ）のみで書き、英語ローマ字表記と混在させない
  （例: 習近平 ○ / Xi習近平 × / Xi ×、プーチン ○ / Putinプーチン ×、ゼレンスキー ○ / Zelenskyゼレンスキー ×）。
  中国は必ず「中国」と表記し、「シナ」「支那」は使わない。
・【英語略語】英語圏でのみ通じる略語・略称は日本語の正式名称に置き換える
  （例: 第二次世界大戦 ○ / WWII ×、第一次世界大戦 ○ / WWI ×）。GDP・AI・EVなど日本語でも定着した略語はそのままでよい。
...
def _summarize_economist(section_name: str, text: str, api_key: str) -> list:
    ...
    prompt = (
        ...
        "「だ」「である」「した」「します」は使わない。\n"
        "【固有名詞】人名・国名・地名は日本語の正式表記（漢字またはカタカナ）のみで書き、"
        "英語ローマ字表記・カタカナ音訳と混在させない"
        "（例: 習近平 ○ / シー・チンピン ×、Xi ×、プーチン ○ / Putinプーチン ×、"
        "ゼレンスキー ○ / Zelenskyゼレンスキー ×、ウクライナ ○ / 烏クライナ ×、ロシア ○ / 露シア ×）。"
        "中国・日本・韓国など漢字圏の要人・地名は漢字表記を優先し、カタカナ音訳しないこと。\n"
        "中国は必ず「中国」と表記し、「シナ」「支那」は絶対に使わない。\n"
